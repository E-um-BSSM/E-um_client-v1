...
export const scheduleApi = {
  classScheduleListSearch: async (class_id: number): Promise<globalResponse<object>> => {
  ...
  classScheduleRegister: async (class_id: number, body:classScheduleRequset): Promise<globalResponse<object>> => {
  ...
  classScheduleUpdate: async (class_id: number,schedule_id:number, body:classScheduleRequset): Promise<globalResponse<classScheduleResponse>> => {
     const response = await req.put(`/classes/${class_id}/schedules/${schedule_id}`,body);
     return response.data;
  },
  classScheduleSingleSearch: async (class_id: number,schedule_id:number): Promise<globalResponse<classScheduleResponse>> => {
